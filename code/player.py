...
class Player(pygame.sprite.Sprite):
    ...
    def input(self):
        ...
        self.direction.x = int(keys[pygame.K_d] or keys[pygame.K_RIGHT]) - int(keys[pygame.K_q] or keys[pygame.K_LEFT])
        self.direction.y = int(keys[pygame.K_s] or keys[pygame.K_DOWN]) - int(keys[pygame.K_z] or keys[pygame.K_UP])
        # normalize
